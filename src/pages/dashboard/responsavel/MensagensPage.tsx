...
import { LayoutDashboard, Calendar, CreditCard, MessageSquare, User, Send, Loader2 } from "lucide-react";
    ...
    <DashboardLayout title="Mensagens" navItems={navItems} roleBadge="Responsável">
      <div className="grid lg:grid-cols-3 gap-6 h-[calc(100vh-10rem)]">
        <div className="bg-card rounded-2xl shadow-card border border-border overflow-hidden">
          <div className="p-4 border-b border-border"><Input placeholder="Buscar..." className="h-9" /></div>
